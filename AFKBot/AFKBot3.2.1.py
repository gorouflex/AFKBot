...
def open_releases():
    webbrowser.open("https://github.com/gorouflex/afkbot/releases/tag/3.2.1")
...
class InfoWindow(ctk.CTkToplevel):
    def __init__(self):
        ...
        self.owner = ctk.CTkLabel(self, text="Main Developer: GorouFlex", font=("", 16))
        self.owner.grid(padx=10, pady=2, sticky="nsew")
        self.github_button = ctk.CTkButton(self, width=130, height=40, text="GitHub",
                                           font=("", 16),
                                           corner_radius=5,
                                           command=open_github)
        self.github_button.grid(row=2, column=0, padx=60, pady=5, sticky="nsew")
        self.releases_button = ctk.CTkButton(self, width=130, height=40, text="Changes logs",
                                             font=("", 16),
                                             corner_radius=5,
                                             command=open_releases)
        self.releases_button.grid(row=3, column=0, padx=60, pady=4, sticky="nsew")
        self.version_label = ctk.CTkLabel(self, width=200,
                                          text=f"Latest version on GitHub: {get_latest_version()}",
                                          font=ctk.CTkFont(size=14))
        self.version_label.grid(row=5, column=0, padx=10, pady=5, sticky="nsew")
...
class Main(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.credit_label = ctk.CTkLabel(self, width=215,
                                         text="Version 3.2.1 Official Build", font=ctk.CTkFont(size=14))
