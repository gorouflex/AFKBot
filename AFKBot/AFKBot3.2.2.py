...
class Main(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.credit_label = ctk.CTkLabel(self, width=215,
                                         text="Version 3.2.2 Official Build", font=ctk.CTkFont(size=14))
