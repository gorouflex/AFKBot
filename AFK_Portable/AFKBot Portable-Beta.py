...
class Main(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.logo_label = ctk.CTkLabel(self.sidebar_frame, text="AFKBot", font=ctk.CTkFont(size=20, weight="bold"))
        ...
        self.credit_label = ctk.CTkLabel(self, width=1100,
                                         text="Credit: GorouFlex aka KRJ | Portable Edition | Version 3.0 (Pre-Beta) | "
                                              "Codename: Next Sunset 2", font=("", 17, "bold"))
