...
class InfoWindow(ctk.CTkToplevel):
    def __init__(self):
        ...
        self.title('About')
        self.owner = ctk.CTkLabel(self, text="Made by GorouFlex", font=("", 16))
        self.owner.grid(padx=10, pady=10, sticky="nsew")
        self.github_button = ctk.CTkButton(self, width=50, height=40, text="Info",
                                           font=("", 16),
                                           corner_radius=10,
                                           command=open_github)
...
class Main(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.test_button = ctk.CTkButton(self.sidebar_frame, width=100, height=40, text="Test",
                                         font=("", 16),
                                         corner_radius=10,
                                         command=self.infowindow)
        self.test_button.grid(row=3, column=0, padx=20, pady=5)
        self.credit_label = ctk.CTkLabel(self, width=215,
                                         text="Version 3.1 Early Development", font=ctk.CTkFont(size=14))
